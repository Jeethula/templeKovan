...
import {  BookDown, Calendar, House, LucideUserCheck2, LucideUserCog2, LucideUsers2, Settings, UserRound } from 'lucide-react';
...
const SearchNav = () => {
  ...
  const mainNav = [
    ...
    { name: 'Special Events',path:'/special',icon:<MdOutlineTempleHindu className='text-lg' size={23}/>},     {name:'Nalla Neram',path:'/nallaneram',icon:<PiCalendarStar className="text-lg" size={25}  />},
