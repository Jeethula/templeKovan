...
const userId=userSession.id;
  useEffect(() => {
    ...
    if (!sessionData.role.includes('posuser') ) {
  ...
  const filteredUsers = users.filter((user) =>
    `${user.personalInfo.firstName} ${user.personalInfo.lastName}`
      .toLowerCase()
      .includes(searchTerm.toLowerCase()) || user.email.toLowerCase().includes(searchTerm.toLowerCase())|| user.phone.toLowerCase().includes(searchTerm.toLowerCase())
