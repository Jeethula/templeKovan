...
//                     type="button"
//                     onClick={() => {
//                       const newRelationships = [...existingRelationships, { id: '', relation: 'son', firstName: '', lastName: '', phone: '' }];
//                       setExistingRelationships(newRelationships);
//                     }}
...
//                             newRelationships[index] = { ...relation, relation: value as 'son' | 'daughter' };
//                             setExistingRelationships(newRelationships);
//                           }}
//                           disabled={!isEditable}
//                         >
...
//                             <SelectItem value="daughter">Daughter
//                              </SelectItem>
//                             </SelectContent>
//                         </FloatingSelect>
//                       </div>
...
//                           onValueChange={(value) => {
//                             const newRelationships = [...existingRelationships];
//                             newRelationships[index] = { ...relation, id: value };
//                             setExistingRelationships(newRelationships);
//                           }}
//                           label="Select Person"
...
//                           variant="destructive"
//                           onClick={() => {
//                             const newRelationships = existingRelationships.filter((_, i) => i !== index);
//                             setExistingRelationships(newRelationships);
//                           }}
//                           className="p-2"
//                         >
